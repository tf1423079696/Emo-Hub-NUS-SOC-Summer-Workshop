...
class AudioFusion:
    ...
    def __init__(self, subdir_model=None):
        ...
        # the dict of the emotion
        # Emotion encoding
        self._emotion = {0:'angry', 1:'disgust', 2:'fear', 3:'happy', 4:'sad', 5:'surprised', 6:'neutral'}
    ...
    def voice_recording(self, filename, duration=5, sample_rate=16000, chunk=1024, channels=1):
        ...
        # Creating audio recording stream
        p = pyaudio.PyAudio()
        ...
        while (current_time - start_time) < duration:
            ...
            # Get new timestamp
            # stop recording when current - start > 5
        ...
        wf.writeframes(b''.join(frames)) # Add the data and save it on the hard drive
        wf.close()
    ...
    '''
    def predict_emotion_from_file(self, filename, chunk_step=16000, chunk_size=49100, predict_proba=True, sample_rate=16000):
